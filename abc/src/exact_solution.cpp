...
template<>
double ExactSolutionABC_PHI<2>::value(const Point<2> &r,
...
template<>
Tensor<1,2> ExactSolutionABC_PHI<2>::gradient(const Point<2> &r,
	unsigned int component) const
{
	Tensor<1,2> p;
...
template<>
double ExactSolutionABC_PHI<3>::value(const Point<3> &r,
...
template<>
Tensor<1,3> ExactSolutionABC_PHI<3>::gradient(const Point<3> &r,
	unsigned int component) const
{
