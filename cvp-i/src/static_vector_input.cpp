...
template<>
void StaticVectorSolver::TheCoefficient<3>::value_list(
...
template<>
void StaticVectorSolver::PdeRhs<3>::value_list(
	const std::vector<Point<3>> &r,
	types::material_id mid,
	unsigned int cuid,
...
template<>
void StaticVectorSolver::Gamma<3>::value_list(
	const std::vector<Point<3>> &r,
...
template<>
void StaticVectorSolver::RobinRhs<3>::value_list(
	const std::vector<Point<3>> &r,
	const std::vector<Tensor<1, 3>> & n,
	types::boundary_id bid,
	types::material_id mid,
...
template<>
void StaticVectorSolver::FreeSurfaceCurrent<3>::value_list(
	const std::vector<Point<3>> &r,
	const std::vector<Tensor<1,3>> & n,
	types::material_id mid,
	unsigned int cuid,
