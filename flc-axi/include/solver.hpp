 ...
 * Must coincide with one of the values set in flc-axi/gmsh/build. This parameter
 ...
 ***************************************************************************/
		...
		fe_slice(1)
	{
		TimerOutput::OutputFrequency tf =
			(SettingsFLCAXI::print_time_tables) ? TimerOutput::summary : TimerOutput::never;
...
template<bool is_cylinder>
void SolverFLCAXI<is_cylinder>::data_slice(std::string fname)
{
...
template<bool is_cylinder>
void SolverFLCAXI<is_cylinder>::solve()
{
