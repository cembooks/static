...
#ifndef SolverFLC_H__
#define SolverFLC_H__
...
private:
	...
	const	ExactSolutionFLC_PHI<dim> exact_solution;
...
template< int dim>
void SolverFLC<dim>::fill_dirichlet_stack()
{
...
template <int dim>
void SolverFLC<dim>::mark_materials()
{
	Point<dim> origin;
...
template <int dim>
void SolverFLC<dim>::data_slice(std::string fname)
{
