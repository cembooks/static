...
/**
 * \brief Implements the *Axisymmetric - interface between dielectrics*
...
public:
   ...
   * Must coincide with one of the values set in int-axi/gmsh/build. This
   * parameter is used to compose the name of the mesh file to be uploaded
   * from int-axi/gmsh/data/.
