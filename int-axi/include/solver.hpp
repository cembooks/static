...
class SolverINTAXI : public SettingsINTAXI, public Solver<2>
{
public:
 ...
 * Must coincide with one of the values set in int-axi/gmsh/build. This parameter
 ...
 *****************************************************************************/
				...
				fe_slice(1)
	{
		...
		TimerOutput::OutputFrequency tf =
			(SettingsINTAXI::print_time_tables) ? TimerOutput::summary : TimerOutput::never;
...
template< bool is_cylinder>
void SolverINTAXI<is_cylinder>::fill_dirichlet_stack()
{
...
template <bool is_cylinder>
void SolverINTAXI<is_cylinder>::data_slice(std::string fname)
{
...
template<bool is_cylinder>
void SolverINTAXI<is_cylinder>::solve()
{
	ReductionControl control(Solver<2>::system_rhs.size(), 0.0, 1e-8, false, false);
