...
#endif
        {
          fname = dir + "solution_PHI_p" + std::to_string(p) + "_r" +
                  std::to_string(r);

          table_PHI.add_value("r", r);
          table_PHI.add_value("p", p);

          if (SettingsINT::print_time_tables)
          ...
          { // Calculating electrostatic field
            fname = dir + "solution_E_p" + std::to_string(p) + "_r" +
                    std::to_string(r);
            ...
            ExactSolutionINT_E<DIMENSION__> exact_solution;
          ...
          { // Calculating displacement
            fname = dir + "solution_D_p" + std::to_string(p) + "_r" +
                    std::to_string(r);
            ...
            ExactSolutionINT_D<DIMENSION__> exact_solution;
