  ...
  void run()
  {
    ...
    for (unsigned int p = 0; p < 3; p++) {
      ...
      for (unsigned int r = 5; r < 9; r++) {
        ...
        ProjectTtoJ stage1(p,
                           mapping_degree,
                           stage0.get_tria(),
                           stage0.get_dof_handler(),
                           stage0.get_solution(),
                           dir + "solution_J_p" + std::to_string(p) + "_r" +
                             std::to_string(r),
                           &exact_solution_Jf,
        ...
        SolverMMSVTI_A stage2(p,
                              ...
                              stage0.get_solution(),
                              r,
                              dir + "solution_A_p" + std::to_string(p) + "_r" +
                                std::to_string(r));
        ...
        ProjectAtoB stage3(p,
                           mapping_degree,
                           stage0.get_tria(),
                           stage2.get_dof_handler(),
                           stage2.get_solution(),
                           dir + "solution_B_p" + std::to_string(p) + "_r" +
                             std::to_string(r),
                           &exact_solution_B,
                           Settings::print_time_tables,
                           Settings::project_exact_solution,
