...
inline Tensor<1, 2> vector_potential(double x, double y, double k)
{
	Tensor<1, 2> A;
...
inline double magnetic_field(double x, double y, double k)
{
 ...
 *****************************************************************************/
class ExactSolutionMMSVTII_T : public Function<2>, public SettingsMMSVTII
{
public:
 ...
 * numerical experiment.
 *****************************************************************************/
class ExactSolutionMMSVTII_Jf : public Function<2>, public SettingsMMSVTII
{
public:
 ...
 * numerical experiment.
 *****************************************************************************/
class ExactSolutionMMSVTII_B : public Function<2>, public SettingsMMSVTII
{
public:
 ...
 * numerical experiment.
 *****************************************************************************/
class DirichletBC_T : public Function<2>, public SettingsMMSVTII
{
public:
 ...
 * numerical experiment.
 *****************************************************************************/
class DirichletBC_A : public Function<2>, public SettingsMMSVTII
{
public:
