...
/**
 * \brief Describes the exact solution, \f$\Phi\f$, of the *Planes of symmetry*
 * [(pls/)](@ref page_pls) numerical experiment in two and three dimensions.
 *****************************************************************************/
template<int dim>
class ExactSolutionPLS_PHI
  : public Function<dim>
  , public SettingsPLS
{
public:
