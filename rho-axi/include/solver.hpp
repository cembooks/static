 ...
 * Must coincide with one of the values set in rho-axi/gmsh/build. This parameter
 ...
 *****************************************************************************/
		...
		fe_slice(1)
	{
		TimerOutput::OutputFrequency tf =
			(SettingsRHOAXI::print_time_tables) ? TimerOutput::summary : TimerOutput::never;
...
template<bool is_cylinder>
void SolverRHOAXI<is_cylinder>::data_slice(std::string fname)
{
...
template<bool is_cylinder>
void SolverRHOAXI<is_cylinder>::fill_dirichlet_stack()
{
...
template<bool is_cylinder>
void SolverRHOAXI<is_cylinder>::solve()
{
