 ...
 *****************************************************************************/
template<int dim>
class SolverRHO : public SettingsRHO, public Solver<dim>
{
public:
...
template< int dim>
void SolverRHO<dim>::fill_dirichlet_stack()
{
...
template <int dim>
void SolverRHO<dim>::mark_materials()
{
...
template <int dim>
void SolverRHO<dim>::data_slice(std::string fname)
{
