...
class SolverSCHAXI : public SettingsSCHAXI, public Solver<2>
{
public:
 ...
 * Must coincide with one of the values set in sch-axi/gmsh/build. This parameter
 ...
 *****************************************************************************/
		...
		fe_slice(1)
	{
		TimerOutput::OutputFrequency tf =
			(SettingsSCHAXI::print_time_tables) ? TimerOutput::summary : TimerOutput::never;
...
template<bool is_cylinder>
void SolverSCHAXI<is_cylinder>::data_slice(std::string fname)
{
...
template<bool is_cylinder>
void SolverSCHAXI<is_cylinder>::fill_dirichlet_stack()
{
...
template<bool is_cylinder>
void SolverSCHAXI<is_cylinder>::solve()
{
