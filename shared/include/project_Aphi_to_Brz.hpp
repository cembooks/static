 ...
 * function space. This class template computes scaled magnetic field \f$\vec{B}'\f$
 ...
 * the StaticScalarSolver::ProjectiAphiToBrz class template reuses the triangulation by
 ...
 * - The \f$L^2\f$ error norm associated with the calculated scaled magnetic field
