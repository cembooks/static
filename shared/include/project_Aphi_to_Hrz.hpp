 ...
 * function space. This class template computes scaled H-field such that \f$\vec{H}\f$
 ...
 * space, which is a proper space for the scaled auxiliary H-field. The operation of
