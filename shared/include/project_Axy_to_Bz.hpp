 ...
 * finite elements. That is, \f$B\f$ is in the \f$L_2\f$
 ...
 * scalar curl, and projects the result into \f$L_2\f$ function space, which is
 ...
 * - The exact solution projected onto \f$L_2\f$ function space is
...
public:
   ...
   * result into the output file next to \f$B\f$.
