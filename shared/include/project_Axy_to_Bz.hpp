 ...
 *the [FE_DGQ](https://www.dealii.org/current/doxygen/deal.II/classFE__DGQ.html)
 ...
 *handler of the degrees of freedom are accessible while \f$B\f$ is computed. An
 *object of the StaticVectorSolver::ProjectAxyToBz class template reuses the
 ...
 *triangulation but are modeled by different finite elements: \f$\vec{A}\f$ - by
 * [FE_Nedelec](https://www.dealii.org/current/doxygen/deal.II/classFE__Nedelec.html)
 * and
 * \f$B\f$ - by
 * [FE_DGQ](https://www.dealii.org/current/doxygen/deal.II/classFE__DGQ.html)
