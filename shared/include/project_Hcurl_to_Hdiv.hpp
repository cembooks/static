...
template<int stage>
void ProjectHcurlToHdiv<stage>::setup()
{
	constraints.close();
...
template<int stage>
void ProjectHcurlToHdiv<stage>::solve()
{
...
template<int stage>
void ProjectHcurlToHdiv<stage>::save() const
{
...
template<int stage>
void ProjectHcurlToHdiv<stage>::compute_error_norms()
{
...
template<int stage>
void ProjectHcurlToHdiv<stage>::project_exact_solution_fcn()
{
...
ProjectHcurlToHdiv<stage>::AssemblyScratchData::AssemblyScratchData(
		...
		qt(fe.degree-1),
		fe_values_Hdiv(mapping, fe, QGauss<3>(qt.sim()),
			update_values |
			update_quadrature_points |
			update_JxW_values),
		fe_values_Hcurl(mapping, dof_hand_Hcurl.get_fe(), QGauss<3>(qt.sim()),
			update_gradients),
...
template<int stage>
void ProjectHcurlToHdiv<stage>::system_matrix_local(
	const IteratorPair & IP,
...
template<int stage>
void ProjectHcurlToHdiv<stage>::copy_local_to_global(const AssemblyCopyData &copy_data)
{
...
template<int stage>
void ProjectHcurlToHdiv<stage>::assemble()
{
	WorkStream::run(
		...
		*this,
		...
		AssemblyScratchData(fe_Hdiv,dof_handler_Hcurl,solution_Hcurl, mapping_degree),
		AssemblyCopyData());
}
} // namespace StaticVectorSolver
