 ...
 *of the degrees of freedom are accessible while \f$\vec{J}_f\f$ is computed. An
 *object of the StaticVectorSolver::ProjectTtoJ class template reuses the
 ...
 *triangulation but are modeled by different finite elements: \f$\vec{T}\f$ - by
 * [FE_Nedelec](https://www.dealii.org/current/doxygen/deal.II/classFE__Nedelec.html)
 * and
 * \f$\vec{J}_f\f$ - by
 * [FE_RaviartThomas](https://www.dealii.org/current/doxygen/deal.II/classFE__RaviartThomas.html).
