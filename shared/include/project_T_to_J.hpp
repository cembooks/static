 ...
 * below.
 *
 * ![](svs_prj/diagram_prj_T_to_J.svg)
 *
 ...
 *   calculated volume free-current density under the names "L2norm" and
 *   "LinftyNorm". One value per mesh cell is saved.
...
public:
   ...
   * result into the output file next to \f$\vec{J}_f\f$.
