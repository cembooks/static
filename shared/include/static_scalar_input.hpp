 ...
 *
 * This class template is declared in shared/include/static_scalar_input.hpp
 * but must be implemented in xyz/src/static_scalar_input.cpp, where xyz is
 ...
 * \f$L^{\infty}\f$, and \f$H^1\f$ error norms.
 *
