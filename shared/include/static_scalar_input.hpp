...
public:
   ...
   *as the value of the coefficient at quadrature point r[i]. The code snippet
   *below provides an example in which the permittivity equals the permittivity
   *of the free space at each quadrature point.
   *
   * @code
...
public:
   ...
   *differential equation. The values[i] is interpreted as the right-hand side
   *of the partial differential equation at quadrature point r[i]. The right-
   *hand side of the partial differential equation may vary from point-to-point,
   *or may have the same value at all points. The following code snippet
   *provides an example.
   * @code
   * #pragma GCC diagnostic push
   * #pragma GCC diagnostic ignored "-Wunused-parameter"
...
public:
   ...
   *values[...] with the values of \f$\gamma\f$. The values[i] is interpreted as
