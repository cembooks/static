...
// As in Step-51 line 1385.
	evaluate_convergence_rates("L2", "ncells", ConvergenceTable::reduction_rate_log2, dimensions);
	evaluate_convergence_rates("H1", "ncells", ConvergenceTable::reduction_rate_log2, dimensions);
...
void MainOutputTable::save(std::string fname)
{
	format();
