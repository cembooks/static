 ...
 *****************************************************************************/
template<int dim>
class ExactSolutionSLDI_PSI : public Function<dim>, public SettingsSLDI
{
public:
 ...
 *****************************************************************************/
template<int dim>
class ExactSolutionSLDI_H: public Function<dim>, public SettingsSLDI
{
public:

	ExactSolutionSLDI_H(): Function<dim>(dim) {}
 ...
 *****************************************************************************/
template<int dim>
class ExactSolutionSLDI_B: public Function<dim>, public SettingsSLDI
{
public:

	ExactSolutionSLDI_B(): Function<dim>(dim) {}
...
template<int dim>
void ExactSolutionSLDI_H<dim>::vector_value_list(const std::vector<Point<dim>> & r,
...
template<int dim>
void ExactSolutionSLDI_B<dim>::vector_value_list(const std::vector<Point<dim>> & r,
	std::vector<Vector<double>> &values) const
{
	Assert(values.size() == r.size(), ExcDimensionMismatch(values.size(), r.size()));
