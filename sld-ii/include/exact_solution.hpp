 ...
 *****************************************************************************/
template<int dim>
class ExactSolutionSLDII_THETA : public Function<dim>, public SettingsSLDII
{
public:
 ...
 *****************************************************************************/
template<int dim>
class ExactSolutionSLDII_H: public Function<dim>, public SettingsSLDII
{
public:

	ExactSolutionSLDII_H(): Function<dim>(dim) {}
 ...
 *****************************************************************************/
template<int dim>
class ExactSolutionSLDII_B: public Function<dim>, public SettingsSLDII
{
public:

	ExactSolutionSLDII_B(): Function<dim>(dim) {}
...
template<int dim>
void ExactSolutionSLDII_H<dim>::vector_value_list(const std::vector<Point<dim>> & r,
...
template<int dim>
void ExactSolutionSLDII_B<dim>::vector_value_list(const std::vector<Point<dim>> & r,
	std::vector<Vector<double>> &values) const
{
	Assert(values.size() == r.size(), ExcDimensionMismatch(values.size(), r.size()));
