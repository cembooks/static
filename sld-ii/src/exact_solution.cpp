...
template<>
ExactSolutionSLDII_THETA<2>::ExactSolutionSLDII_THETA()
  : Function<2>()
  , SettingsSLDII()
{
  double mur = mur_2;
...
template<>
double
ExactSolutionSLDII_THETA<2>::value(const Point<2>& r,
...
template<>
Tensor<1, 2>
ExactSolutionSLDII_THETA<2>::gradient(const Point<2>& r,
                                      unsigned int component) const
{
  double rn = r.norm();
  double r2 = std::pow(rn, 2.0);
...
template<>
ExactSolutionSLDII_THETA<3>::ExactSolutionSLDII_THETA()
  : Function<3>()
  , SettingsSLDII()
{
  double mur = mur_2;
...
template<>
double
ExactSolutionSLDII_THETA<3>::value(const Point<3>& r,
...
template<>
Tensor<1, 3>
ExactSolutionSLDII_THETA<3>::gradient(const Point<3>& r,
                                      unsigned int component) const
{
  double rn = r.norm();
  double r3 = std::pow(rn, 3.0);
