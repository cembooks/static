 ...
 * Must coincide with one of the values set in ssol-i-axi/gmsh/build. This parameter
 * is used to compose the name of the mesh file to be uploaded from
 * ssol-i-axi/gmsh/data/.
 ...
 *****************************************************************************/
		...
		fe_slice(1)
	{
		TimerOutput::OutputFrequency tf =
			(SettingsSSOLIAXI::print_time_tables) ? TimerOutput::summary : TimerOutput::never;
