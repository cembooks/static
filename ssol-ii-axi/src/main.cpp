 ...
 *****************************************************************************/
class BatchSSOLIIAXI : public SettingsSSOLIIAXI
{
public:
  void run()
  {
    ...
    for (unsigned int p = 1; p < 4; p++) {
      ...
      for (unsigned int r = 15; r < 19; r++) { // Calculate A'.
        fname =
        ...
        if (SettingsSSOLIIAXI::print_time_tables)
          std::cout << "Time table A \n";

        SolverSSOLIIAXI problem(p, 2, r, fname);
        ...
        { // Calculate H'.
          ...
          ExactSolutionSSOLIIAXI_H exact_solution;
        ...
        { // Calculate B'.
          ...
          ExactSolutionSSOLIIAXI_B exact_solution;
