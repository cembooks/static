	...
	double J_0, double mu_0, double a, double b)
{
	...
	F2 = (2.0 / 3.0) * mu_0 * J_0 * (cos_theta*r_hat + 0.5*sin_theta*theta_hat) / pow(r,3);
 ...
 *****************************************************************************/
class ExactSolutionSSOLIIIAXI_B : public Function<2>, public SettingsSSOLIIIAXI
{
public:

	ExactSolutionSSOLIIIAXI_B(): Function<2>(2), B_0(2.0*mu_0*K_0/3.0) {}
 ...
 * numerical experiment.
 *****************************************************************************/
class ExactSolutionSSOLIIIAXI_H: public Function<2>, public SettingsSSOLIIIAXI
{
public:

	ExactSolutionSSOLIIIAXI_H(): Function<2>(2) {}
